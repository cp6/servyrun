...
allows you to run simple SSH commands, check uptime and do pings to your servers. Surcuri was developed to handle
multiple users and provides options to store connection information securely.

The full features of Surcuri as of January 2023:
