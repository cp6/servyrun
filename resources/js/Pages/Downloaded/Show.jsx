                ...
                <section className="bg-white/50 dark:bg-gray-700 rounded-lg shadow-sm">
                    <div className="py-4 px-4 mx-auto max-w-7xl">
                        <div className="flex items-center justify-between">
                            <div>
                                    <span
                                        className="bg-indigo-100 text-indigo-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-indigo-900 dark:text-indigo-300">{new Intl.NumberFormat('en-IN', {maximumSignificantDigits: 3}).format(resource.size / 1000 / 1000)} MB</span>
                                <span
                                    className="ml-1 bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">{new Intl.NumberFormat('en-IN', {maximumSignificantDigits: 3}).format(resource.speed_mbps)} Mbps</span>
                            </div>
