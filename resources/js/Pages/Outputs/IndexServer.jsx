...
export default function IndexServer({auth}) {
    ...
    return (
        <AuthenticatedLayout
            auth={auth}
            header={<h2
                className="font-semibold text-xl text-gray-800 dark:text-white leading-tight">{'Command outputs for ' + server.hostname}</h2>}>
            <Head title={'Command outputs for ' + server.hostname}/>
