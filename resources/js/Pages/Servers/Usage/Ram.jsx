...
export default function Ram({auth}) {
    ...
    return (
        <AuthenticatedLayout
            auth={auth}
            header={<h2
                className="font-semibold text-xl text-gray-800 dark:text-white leading-tight">{resource.title + ' RAM usage'}</h2>}
        >
            <Head title={"RAM usage " + resource.hostname}/>
