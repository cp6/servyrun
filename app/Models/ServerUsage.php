...
class ServerUsage extends Model
{
    ...
    protected $fillable = ['cpu_usage', 'ram_used_percent', 'disk_used_percent', 'disk_used', 'disk_available', 'net_out', 'net_in', 'total_net_out', 'total_net_in', 'total_net'];
    ...
    protected static function booted(): void
    {
        ...
        static::deleted(function (ServerUsage $serverUsage) {
